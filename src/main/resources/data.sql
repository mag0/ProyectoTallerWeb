...
INSERT INTO Pedido(nombre,tipo,codigo,tamanio,peso,fecha,estado,destino_id) VALUES
    ...
    ("Paquete 2","Alimentos","DS226",15,20,"2024-06-07",'DISPONIBLE',4),
    ("Paquete 3","Ropa","DS227",5,3,"2024-06-04",'DISPONIBLE',2),
    ("Paquete 4","Accesorios","DS228",5,10,"2024-06-07",'DISPONIBLE',5),
    ("Paquete 5","Herramientas","DS229",20,30,"2021-06-08",'DISPONIBLE',3),
    ("Paquete 6","Electronica","DS230",8,12,"2024-06-09",'DISPONIBLE',2),
    ("Paquete 7","Alimentos","DS231",12,18,"2024-06-06",'DISPONIBLE',4),
    ...
    ("Paquete 12","Alimentos","DS236",14,22,"2024-06-08",'DISPONIBLE',4),
    ...
    ("Paquete 19","Accesorios","DS243",8,14,"2024-06-04",'DISPONIBLE',5),
...
VALUES
    ...
    ("Honda", "Civic", "Auto", 140000, 12000, 1100, 115, "STU234", true, 1),
    ("Ducati", "Monster 821", "Moto", 40000, 7000, 900, 30, "VWX890", false, 1),
